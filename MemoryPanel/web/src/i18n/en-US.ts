...
export const enUS = {
  ...
  'attribution.pool.stateLocalHint': 'Status reflects submissions made in this browser session (no server-side reader yet); the server still enforces the transition table and prev_status',
