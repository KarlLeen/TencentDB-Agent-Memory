...
export const enUS = {
  ...
  'memory.detail.searchEmpty': 'No related memories found — try another keyword',
  'memory.detail.searchPlaceholderL0': "Semantic search over this memory's L0 conversation text…",
  'memory.detail.searchPlaceholderL1': "Semantic search over this memory's L1 atomic memories…",
  'memory.detail.searchPrompt': 'Enter a keyword to search this memory semantically; results are ranked by relevance (not limited by time range).',
  'memory.detail.searchResultCount': '{{count}} related results',
  ...
  // ===== Attribution panel (76 · S7-c) =====
  'menu.attribution_receipt': 'Attribution Receipt',
  'menu.audit_pool': 'Audit Pool',
  'menu.desc.attribution_receipt': 'Decision-unit judgement details (receipt page)',
  'menu.desc.audit_pool': 'Unfiltered candidates: suspect / disagreement / dead-letter',
  'attribution.refresh': 'Refresh',
  'attribution.receipt.title': 'Attribution Receipt',
  ...
  'attribution.receipt.events': 'Status events',
  'attribution.receipt.assets': 'Asset version chain (observed in this session)',
  'attribution.receipt.truncated': '(truncated: showing the first page only)',
  'attribution.receipt.used': 'Used',
  'attribution.receipt.corrected': 'Corrected',
  'attribution.receipt.pending': 'Pending',
  'attribution.receipt.failed': 'Failed',
  'attribution.receipt.unit': 'Unit',
  'attribution.receipt.verdict': 'Verdict',
  'attribution.receipt.missing': 'Missing',
  // 126 · view-model injected t (D1 (i): stays pure; copy moved to keys)
  'attribution.receipt.detectedSnapshot': 'Snapshot at detection',
  'attribution.receipt.detectedNote': '{{label}} (candidate {{a}} → current {{l}})',
  'attribution.receipt.turnLabel': 'Turn {{turn}} · Msg {{msg}}',
  'attribution.receipt.overflow': '{{pending}} secondary decisions not attributed individually (top-N gate; kept pending, next round FIFO first)',
  // 145 · summary layer + three-tier effect status (C1/C2); semantic map lives in utils/semantic-type.ts (144 · C1)
  'attribution.receipt.summary.title': '{{n}} team assets applied in this session',
  'attribution.receipt.summary.item': '{{label}}: {{purpose}}',
  'attribution.receipt.semanticType.projectConvention': 'Project convention',
  'attribution.receipt.semanticType.historicalPlan': 'Historical plan',
  'attribution.receipt.semanticType.failureLesson': 'Failure lesson',
  'attribution.receipt.semanticType.skill': 'Skill',
  'attribution.receipt.semanticType.codeKnowledge': 'Code knowledge',
  'attribution.receipt.semanticType.productKnowledge': 'Product knowledge',
  'attribution.receipt.semanticType.other': 'Other',
  'attribution.receipt.purpose.codeChange': 'decision basis at a code change',
  'attribution.receipt.purpose.keyToolCall': 'decision basis at a key tool call',
  'attribution.receipt.purpose.restraint': 'decision basis at a risk-restraint point',
  'attribution.receipt.purpose.generic': 'decision basis in this session',
  'attribution.receipt.purpose.background': 'background reference only (no confirmed citation detected)',
  'attribution.receipt.effect.used': '{{n}} used',
  'attribution.receipt.effect.corrected': '{{n}} corrected (snapshot at detection)',
  'attribution.receipt.effect.pending': '{{n}} background only, effect pending verification',
  'attribution.receipt.effect.none': 'No used or corrected assets in this session',
  'attribution.receipt.effect.separator': '; ',
  'attribution.receipt.effect.note': 'Effect evaluation (controlled comparison) is covered by Task 5',
  // 144 · expand-layer fields (C2/C3/C4); missing values render as "—" + tooltip "unknown" (never 0 / empty string)
  'attribution.receipt.asset.name': 'Name',
  'attribution.receipt.asset.semanticType': 'Semantic type',
  'attribution.receipt.asset.assetType': 'Technical type',
  'attribution.receipt.asset.version': 'Version',
  'attribution.receipt.asset.updatedAt': 'Updated at',
  'attribution.receipt.asset.source': 'Source',
  'attribution.receipt.asset.verification': 'Verification',
  'attribution.receipt.asset.risks': 'Risks',
  'attribution.receipt.asset.usage': 'Usage locations (this session)',
  'attribution.receipt.asset.changes': 'Related code changes / decisions / tests',
  'attribution.receipt.missingValue': '—',
  'attribution.receipt.unknown': 'unknown',
  'attribution.receipt.verification.pending': 'Pending verification (no verifier defined)',
  'attribution.receipt.risk.none': 'None (not detected)',
  'attribution.receipt.risk.versionDrift': 'Version drift (snapshot at detection)',
  'attribution.receipt.anchor.none': 'No change anchor in this session',
  // 146 · stage naming (single definition = utils/stage-vocabulary.ts; maps existing carriers only)
  'attribution.receipt.stage.recalled': 'recalled',
  'attribution.receipt.stage.selected': 'selected',
  'attribution.receipt.stage.injected': 'injected',
  'attribution.receipt.stage.used': 'used',
  'attribution.receipt.stage.corrected': 'corrected',
  'attribution.receipt.stage.line': 'Stage vocabulary: {{chain}}',
  'attribution.receipt.stage.tag': ' ({{label}})',
  // 149 · change/outcome wiring (usage locations / related changes; counts + enums only, no raw paths/commands)
  'attribution.receipt.usage.citedAt': 'Materially used at {{location}} ({{detail}})',
  'attribution.receipt.usage.anchoredAsset': '{{n}} cited decision units carry change/outcome anchors',
  'attribution.receipt.usage.noneForAsset': 'No change/outcome anchor matched this asset (session total: {{total}})',
  'attribution.receipt.changes.summary': '{{kinds}} (total {{total}}; ok {{ok}} / error {{error}} / unanchored {{unanchored}})',
  'attribution.receipt.changeKind.edit': 'edit',
  'attribution.receipt.changeKind.write': 'write',
  'attribution.receipt.changeKind.runTests': 'run tests',
  ...
  'attribution.receipt.asset.attribution': 'Attribution chain (judge verdicts)',
  'attribution.receipt.asset.rationale': 'Judge rationale',
  'attribution.receipt.asset.action': 'Concrete action',
  'attribution.receipt.asset.actionToolCall': '{{tool}}: {{param}}',
  'attribution.receipt.asset.verdict.confirmed': 'Used (judge confirmed)',
  'attribution.receipt.asset.verdict.unconfirmed': 'Unconfirmed (judge rationale)',
  'attribution.receipt.asset.noAttribution': 'No judgement for this asset in this session',
  ...
  'attribution.receipt.why.citedSemantic': 'Judge semantic confirmation (follows asset after text comparison)',
  ...
  'attribution.pool.allCategories': 'All categories',
  'attribution.pool.unit': 'Unit',
  'attribution.pool.categories': 'Categories',
  'attribution.pool.verdict': 'Verdict',
  'attribution.pool.reviewTitle': 'Status',
  'attribution.pool.target': 'Target',
  'attribution.pool.note': 'Note (≤2000)',
  'attribution.pool.submit': 'Submit',
  'attribution.pool.submitOk': 'Submitted ({{kind}})',
  'attribution.pool.noUserKey': 'No user key in this session — anonymous review is not allowed; sign in with a user key',
  'attribution.pool.stateLocalHint': 'Status = server-side latest-join (review history is append-only); the server enforces the transition table and prev_status on submit',
  'attribution.pool.reviewFilter': 'Review status (server-side filter)',
  'attribution.pool.allStatuses': 'All statuses',
  'attribution.pool.stale': 'Current status has been updated to "{{current}}"; refresh and retry',
  'attribution.marker.unexecuted': 'Not executed',
  'attribution.empty.noData': 'No data yet (no attribution records in the database)',
  'attribution.empty.notConfigured': 'ATTRIBUTION_PROXY_ADMIN_KEY is not configured — the attribution pages are unavailable',
  'attribution.empty.unreachable': 'Upstream proxy unreachable (check ATTRIBUTION_PROXY_BASE_URL or retry later)',
  'attribution.error.ATTRIBUTION_PROXY_NOT_CONFIGURED': 'ATTRIBUTION_PROXY_ADMIN_KEY is not configured — the attribution pages are unavailable',
  'attribution.error.ATTRIBUTION_PROXY_UNAUTHORIZED': 'The proxy rejected the admin key (check ATTRIBUTION_PROXY_ADMIN_KEY)',
  'attribution.error.ATTRIBUTION_PROXY_UNREACHABLE': 'Upstream proxy unreachable',
  'attribution.error.ATTRIBUTION_PROXY_UNAVAILABLE': 'Upstream proxy temporarily unavailable',
  'attribution.error.ATTRIBUTION_PROXY_BAD_REQUEST': 'Invalid request parameters',
  'attribution.error.ATTRIBUTION_PROXY_NOT_FOUND': 'Target not found',
  'attribution.error.ATTRIBUTION_PROXY_PROTOCOL_ERROR': 'Unexpected upstream response',
  'attribution.error.ATTRIBUTION_UNKNOWN_ERROR': 'Unknown error',
};
